...
###### ⭐内部寄存器
![8086CPU内部结构.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/assembly/8086CPU内部结构.webp)
...
![8086的4个段寄存器.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/assembly/8086的4个段寄存器.webp)
...
###### 通用寄存器
E开头，是Extended的意思。
![IA32的8个通用寄存器.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/assembly/IA32的8个通用寄存器.webp)
...
###### 逻辑地址转换为线性地址的过程
“索引” 是描述符在 GDT 中的 “序号”
![段描述符在GDT中访问.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/assembly/段描述符在GDT中访问.webp)

![段描述符在LDT中访问.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/assembly/段描述符在LDT中访问.webp)
###### 平坦存储模式
...
```
![比较指令MOV与LEA.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/assembly/比较指令MOV与LEA.webp)
...
![入口地址与断点图示理解.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/assembly/入口地址与断点图示理解.webp)

...
![resnet论文模型结构图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/resnet论文模型结构图.webp)
为了降低计算量，高维度输入，先投影到低维，然后变换后，在输出前再升维

![resnet解决深度网络问题.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/resnet解决深度网络问题.webp)
...
![ViT模型结构图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/ViT模型结构图.webp)
...
![clip论文模型总览图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/CLIP论文模型总览图.webp)
### 优缺点
图文匹配的效率和性能突出，学习到的特征语义性强，可扩展至图像检测、图像生成、视频检索等多个领域。
**但图文交互深度不足，融合层只是简单乘积没有可学习参数**，难以处理需要精细对齐的任务（如“图中的狗有几只？”这类计数、细节描述类问题）。
![CLIP模型成绩图论文.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/CLIP模型成绩图.webp)
伪代码训练过程
```python
...
![ViLT论文结构与卖点图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/ViLT论文结构与卖点图.webp)
ViLT的VE和TE都是轻量的线性嵌入层，

![ViLT及之前的四种经典多模态模型结构.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/ViLT及之前的四种经典多模态模型结构.webp)
...
![https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/ViLT论文模型结构图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/ViLT论文模型结构图.webp)
...
### MAE模型结构
![MAE模型结构论文图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/MAE模型结构图.webp)
### 模型效果
![MAE效果图Mask对比.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/MAE效果图Mask对比.webp)
...
![ALBEF论文模型结构图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/ALBEF论文模型结构图.webp)
...
![ALBEFpseudo-targets示例.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/ALBEF伪目标示例图.webp)
## VLMo
[VLMo: Unified Vision-Language Pre-Training with Mixture-of-Modality-Experts](https://arxiv.org/pdf/2111.02358)
### 混合专家模型结构
![VLMo论文模型结构图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/VLMo论文模型结构图.webp)

### 分阶段训练
stagewise pre-traning stragety
实验证明Self-Attentino层可以共享参数，先用Vision作训练，冻结Self-Attention，再作文本训练，效果才比较好，反之不行（未解）。
需要做多次Forward。
![VLMo模型训练方法图示例.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/VLMo模型训练方法图.webp)
...
![BLIP论文模型结构图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/BLIP论文模型结构图.webp)
### Cap Filter Model
最重要的贡献是Cap Filter Model ，将Noisy Data生成更为干净的数据。
![BLIPcapfilter模型结构图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/BLIPcapfilter模型结构图.webp)

![BLIPcapfilter效果示例图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/BLIPcapfilter效果示例图.webp)
...
![CoCa论文模型结构图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/CoCa论文模型结构图.webp)
...
![2021年前视频理解领域论文时间线图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/2021年前视频理解领域论文时间线图.webp)
## Hand-crafted—>CNN
...
![早期的图片识别应用到视频领域的想法图.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/早期图片识别应用到视频领域的想法图.webp)
...
![双流神经网络结构图论文.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/mlm/双流神经网络结构图.webp)

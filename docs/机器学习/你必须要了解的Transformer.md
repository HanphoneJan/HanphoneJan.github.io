...
![Transformer架构图](https://hanphone.top/gh/HanphoneJan/public-pictures/ml/transformer论文结构图.webp)

## 分词 (Tokenization) 

文本到向量的流程是：
```plaintext
Tokenization（分词/切 token）  
↓  
Token IDs（数字化）  
↓  
Embedding（查表变向量）
...
![BPE 算法合并过程示例](https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/3-figures/1757249275674-5.png)
...
![自注意力机制和卷积和循环神经网络结构对比图](https://hanphone.top/gh/HanphoneJan/public-pictures/ml/自注意力机制和卷积和循环神经网络结构对比图.webp)
...
- **步骤 1：线性变换**：将输入的查询（Query）、键（Key）、值（Value）通过不同的线性层（全连接层）投影到多个子空间变成多头。例如，假设输入维度是 100，分成 5 个头，每个头的维度变为 20（100/5=20）。
  - 公式：$\text{Query}_i = W_i^Q \cdot \text{Query}, \quad \text{Key}_i = W_i^K \cdot \text{Key}, \quad \text{Value}_i = W_i^V \cdot \text{Value}$ （每个头有独立的投影矩阵$W_i^Q, W_i^K, W_i^V$，且总输入维度需能被头数整除）
    ![单头注意力变多头注意力.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/learn/%E5%8D%95%E5%A4%B4%E6%B3%A8%E6%84%8F%E5%8A%9B%E5%8F%98%E5%A4%9A%E5%A4%B4%E6%B3%A8%E6%84%8F%E5%8A%9B.webp)
- **步骤 2：并行计算注意力**：每个头独立计算注意力权重，得到各自的输出，每个头对应一个独特的语义子空间（捕捉不同类型的语义关联，如语法依赖、语义相似性）。
  ...
  ![用query与各个词的key相乘得到value.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/learn/%E7%94%A8query%E4%B8%8E%E5%90%84%E4%B8%AA%E8%AF%8D%E7%9A%84key%E7%9B%B8%E4%B9%98%E5%BE%97%E5%88%B0value.webp)
- **步骤 3：结果拼接与变换**：将各头的输出按维度拼接，恢复至原输入维度，再通过一个线性层融合多头部信息，得到最终的自注意力输出。
  ![拼接value得到带全部上下文信息的词向量.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/learn/%E6%8B%BC%E6%8E%A5value%E5%BE%97%E5%88%B0%E5%B8%A6%E5%85%A8%E9%83%A8%E4%B8%8A%E4%B8%8B%E6%96%87%E4%BF%A1%E6%81%AF%E7%9A%84%E8%AF%8D%E5%90%91%E9%87%8F.webp)
...
![单头与多头注意力机制结构对比.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/learn/%E5%8D%95%E5%A4%B4%E4%B8%8E%E5%A4%9A%E5%A4%B4%E6%B3%A8%E6%84%8F%E5%8A%9B%E6%9C%BA%E5%88%B6%E7%BB%93%E6%9E%84%E5%AF%B9%E6%AF%94.webp)
...
- 结构：由多个解码器块（Decoder Block）堆叠而成，每个块包含：
  ...
  3. **前馈神经网络、残差连接和层规范化**：与编码器类似。
     ![Transformer编码器解码器图解.webp](https://hanphone.top/gh/HanphoneJan/public-pictures/learn/Transformer%E7%BC%96%E7%A0%81%E5%99%A8%E8%A7%A3%E7%A0%81%E5%99%A8%E5%9B%BE%E8%A7%A3.webp)

## 残差连接

Add操作，将某一层的输入与该层经过处理后的输出进行逐元素相加，再传入后续的层（通常是 Layer Normalization 层）。**防止某层很烂导致整体很差。**
